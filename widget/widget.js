  ...
  <div class="container-fluid py-1 bottom" style="font-size:12px; background:url('/../skins/img/bottom.png') no-repeat; background-size:100% 100%; position: fixed; bottom: 0; left: 0; z-index: 10; height:75px">
    ...
    <div class="col" style='text-align: center; padding:0;'>
      <a href="/front/company/home" style='display: block; width: 100%; height: 100%;'>
        <i class="icon notbig" style='font-size:1rem!important;' v-if="keyword != 'home'">&#xe8e2;</i>
        <i class="icon notbig" style='font-size:1rem!important; color:#01aaef!important' v-if="keyword == 'home'">&#xe8e6;</i>
        <p class="mb-0" style='font-size:0.8rem;' :class="{'t-c-01aaef' : keyword == 'home'}">首页</p >
      </a>
    </div>
    <div class="col" style=' text-align: center; padding:0;'>
      <a href="/front/company/recruit_list" style='display: block; width: 100%; height: 100%;'>
        <i class="icon notbig" style='font-size:1rem!important;' v-if="keyword != 'recruit'">&#xe8e7;</i>
        <i class="icon notbig" style='font-size:1rem!important; color:#01aaef!important' v-if="keyword == 'recruit'">&#xe8e5;</i>
        <p class="mb-0" style='font-size:0.8rem;' :class="{'t-c-01aaef' : keyword == 'recruit'}">招聘</p >
      </a>
    </div>
    <div class="col" style=' text-align: center; padding:0;'>
      <a href="/front/company/play" style='display: block; width: 100%; height: 100%; color: #323232;'>
        ...
        <p class="mb-0 play" style='padding-top:29%;' style='font-size:0.8rem;' :class="{'t-c-01aaef' : keyword == 'play'}">新区直播</p >
      </a>
    </div>
    <div class="col" style=' text-align: center; padding:0;'>
      <a href="/front/company/cultivate_list" style='display: block; width: 100%; height: 100%;'>
        <i class="icon notbig" style='font-size:1rem!important;' v-if="keyword != 'cultivate'">&#xe8ea;</i>
        <i class="icon notbig" style='font-size:1rem!important; color:#01aaef!important' v-if="keyword == 'cultivate'">&#xe8e8;</i>
        <p class="mb-0" style='font-size:0.8rem;' :class="{'t-c-01aaef' : keyword == 'cultivate'}">培训</p >
      </a>
    </div>
    <div class="col" style=' text-align: center; padding:0;'>
      <a href="/front/company/compan_home" style='display: block; width: 100%; height: 100%;'>
        <i class="icon notbig" style='font-size:1rem!important;' v-if="keyword != 'my'">&#xe8e4;</i>
        <i class="icon notbig" style='font-size:1rem!important; color:#01aaef!important' v-if="keyword == 'my'">&#xe81e;</i>
        <p class="mb-0" style='font-size:0.8rem;' :class="{'t-c-01aaef' : keyword == 'my'}">我的</p >
      </a>
    </div>
  </div>
</div>
    ...
    <div class="container-fluid py-1 bottom" style="font-size:12px; background:url('/../skins/img/bottom.png') no-repeat; background-size:100% 100%; position: fixed; bottom: 0; left: 0; z-index: 10; height:75px">
      ...
      <div class="col" style=' text-align: center; padding:0;'>
        <a href="/front/jobseeker/jobseeker_list" style='display: block; width: 100%; height: 100%; color: #323232!important;'>
          <i class="icon notbig" style='font-size:1rem!important;' v-if="keyword != 'recruit'">&#xe8e7;</i>
          <i class="icon notbig" style='font-size:1rem!important; color:#01aaef!important' v-if="keyword == 'recruit'">&#xe8e5;</i>
          <p class="mb-0" style='font-size:0.8rem;' :class="{'t-c-01aaef' : keyword == 'recruit'}">求职</p >
        </a>
      </div>
      <div class="col" style=' text-align: center; padding:0;'>
